...
public class Update extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        upnext = new javax.swing.JButton();
        ...
        modData.setBackground(new java.awt.Color(102, 102, 102));
        ...
        jPanel3.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 280, 200, -1));
        ...
        jPanel3.add(update, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 480, 100, 40));

        upnext.setBackground(new java.awt.Color(51, 51, 51));
        upnext.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        upnext.setForeground(new java.awt.Color(255, 255, 255));
        upnext.setText("UPDATE NEXT");
        upnext.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                upnextActionPerformed(evt);
            }
        });
        jPanel3.add(upnext, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 480, 120, 40));
        ...
        jLabel9.setText("UPDATE EMPLOYEE DATA");
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        int ans=JOptionPane.showConfirmDialog(null,"Are You sure You want to Update Record");
        ...
        if(ans==JOptionPane.YES_OPTION)
        {
            try
            {
                ...
                String qry="UPDATE empdata set empno="+eno+",ename="+"'"+name+"'"+",basic="+b+",hra="+h+",da="+d+",pf="+p+",net="+n+" Where empno="+eno+";";
    ...
    private void upnextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_upnextActionPerformed
    ...
    }//GEN-LAST:event_upnextActionPerformed
    ...
    private void loadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadActionPerformed
        try{
                ...
                if(rs.next())
                {
                    ...
                    basicsal.setText(""+rs.getDouble("basic"));
                    hra.setText(""+rs.getDouble("hra"));
                    da.setText(""+rs.getDouble("da"));
                    pf.setText(""+rs.getDouble("basic"));
                    netsal.setText(""+rs.getDouble("net"));
    ...
    private javax.swing.JButton upnext;
